...
//  ZONE-SMOKE
//
//  Created by Даниил Арсентьев on 19.06.2022.
//

import SwiftUI

struct ProductFoodCart: View {
   ...
   // @State var selected = false
    ...
    var body: some View {
        HStack{
            ...
            VStack{
                Text("Кол \(connectCartFood.checkProductInCartFood(product: product))")
                    .font(.system(size: 25))
...
struct ProductFood2_Previews: PreviewProvider {
    static var previews: some View {
        ProductFoodCart(product: Product(id: 892, title: "Салат цезарь", imageUrl: "https://povar.top/art/img/caesar-chicken-1.jpg", price: 300, descript: "Мой родной салатик", brand: "Cалаты", taste: ["Курица", "Сыр", "Салат", "Чери", "Гренки"], strong: 300, count: 0))
    }
}
