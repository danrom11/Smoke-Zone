...
struct HookahButton: View {
    ...
    struct HookahButton_Previews: PreviewProvider {
        static var previews: some View {
            HookahButton(hookah: Hookah(id: 1, title: "Топ кальян за свои денги", bowl: ElementHookah(id: 0, image: "hookahStandart", text: "На чаше", typeObject: "standart"), flask: ElementHookah(id: 0, image: "InBotleWater", text: "На воде", typeObject: "water"), tobacco: [Product](arrayLiteral: Product(id: 765, title: "Barvy Orange", imageUrl: "https://smogus.cc/wp-content/uploads/2020/03/tabak16.jpg", price: 300, descript: "Вкус состоит из ароматизаторов помело, который является основным, и грейпфрута, который используется для придания вкуса цедра и горчинки. Сама аромка помело имеет кислинку и больше напоминает мякоть этого цитруса.", brand: "DarkSide (Core)", taste: ["Апельсин", "Грейпфрукт"], strong: 1, count: 1))), activateRootLink: .constant(false), IDReadyHookah: .constant(-1))
        }
    }
