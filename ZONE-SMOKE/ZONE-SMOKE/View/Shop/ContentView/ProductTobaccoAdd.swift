...
//                    .padding(.leading)
            ...
            Button(action: {
                ...
                if(self.selected == false){
                    CatalogViewModel.shared.cartTabacco.append(product)
                } else {
                    CatalogViewModel.shared.cartTabacco.remove(at: CatalogViewModel.shared.serchIndex(product: product, array: CatalogViewModel.shared.productsTabacco))
                }
                self.selected.toggle()
            }, label: {
                // var check = selected == true ? "plus.circle" : "checkmark.circle"
                Image(systemName: self.selected == false ? "plus.circle" : "checkmark.circle")
